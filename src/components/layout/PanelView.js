    ...
    return (
      <div className={'inner '+classTab}>
        ...
        <div id="body" className="">
          <div className="mbv-grid container-fluid" style={{"zIndex": "9999984"}}>
            <div className="row">
              <div className="col-xs-12">
                <div className="mbv-panel-container-with-controls">
                  <div className="mbv-panel-container" style={{"zIndex": "9999998", "display": "block", "height": "auto"}}>
                              ...
                              <div className="col-xs-12">
                                <div id="example_wrapper" className="dataTables_wrapper">
                                  ...
                                  <div id="example_filter" className="dataTables_filter" style={{"display": "inline-flex", "float":"right"}}>
                                    <label style={{"display": "flex"}}>Search:
