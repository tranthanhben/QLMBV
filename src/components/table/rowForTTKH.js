  ...
  render(){
    ...
    return (
      <tr role="row" className={index%2===1 ? "even":"odd"} key={index}>
        <td>{index+1}</td>
        <td key='thanhtoan'>
          <input type="number" step='10' min='0' data-addr='thanhtoan'className="form-control dt-body-right" value={item.thanhtoan || ''} placeholder='So tien thanh toán' onChange={edit} />
        </td>
        <td key='phuongthuc'>
