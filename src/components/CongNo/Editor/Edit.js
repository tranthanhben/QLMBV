...
import * as khoActions from '../../../actions/congnoActions';

@connect(state =>({
  error: state.congno.postError,
  message: state.congno.message,
  item: state.congno.editItem,
  meta: state.meta.congno
}), {...khoActions})
