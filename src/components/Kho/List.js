...
import {isLoaded, loadList as loadNV} from '../../actions/khoActions';
        ...
        <div className="row">
          <div className="col-xs-12">
            <div id="example_wrapper" className="dataTables_wrapper">
              ...
              <div className="dataTables_info" id="example_info" role="status" aria-live="polite">Showing {paging && paging.page * paging.page_size+ 1} to {paging && paging.page * paging.page_size+ listK.length} of {paging && paging.total} entries</div>
